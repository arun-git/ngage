...
/// Enhanced leaderboard display widget with multiple view modes
class LeaderboardDisplayWidget extends StatelessWidget {
  ...
  const LeaderboardDisplayWidget({
    super.key,
  ...
  Widget _buildPodiumView(BuildContext context) {
    final topThree = leaderboard.getTopEntries(3);
