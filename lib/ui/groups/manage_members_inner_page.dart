...
/// Inner page for managing group members that replaces the group detail content
class ManageMembersInnerPage extends ConsumerStatefulWidget {
  final String groupId;
  final String currentMemberId;
  final String groupName;
  final VoidCallback onBack;

  const ManageMembersInnerPage({
    super.key,
  ...
  @override
  ConsumerState<ManageMembersInnerPage> createState() => _ManageMembersInnerPageState();
}

class _ManageMembersInnerPageState extends ConsumerState<ManageMembersInnerPage> {
